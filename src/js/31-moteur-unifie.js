...
function buildResultatLines(rN, rN1){
    var PLAN = [
        ...
        ['6033,6038 (SD-SC)',        "Variation de stocks d'autres approvisionnements  (RF)", 'RF', 0],
        ...
        ['791 (SC)',                 "Reprises d'amortissements, provisions et dépréciations  (TJ)", 'TJ', 0],
        ['681,69 (SD)',              'Dotations aux amortissements, provisions et dépréciations  (RL)', 'RL', 0],
